...
export const PERMISSIONS: Record<string, UserRole[]> = {
  ...
  'repertories:create':   ['intermediario', 'master', 'administrador'],
  'repertories:view':     ['padrao', 'intermediario', 'master', 'administrador'],
  'repertories:share':    ['intermediario', 'master', 'administrador'],
